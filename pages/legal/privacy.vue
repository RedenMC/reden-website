<template>
  <div style="max-width: 900px; margin: auto">
    ...
    <h4>（一）您使用我司产品或服务过程中我们收集和使用的信息</h4>
    <p>
      我们仅会出于本政策所述的业务功能，收集和使用您的用户信息，收集用户信息的目的在于向您提供产品或服务，您有权自行选择是否提供该信息，但多数情况下，如果您不提供，我们可能无法向您提供相应的服务，也无法回应您遇到的问题：
    </p>
    <p>
      在您使用我们的服务时，允许我们收集您自行向我们提供的或为向您提供服务所必要的信息包括：**账户昵称、密码、密码保护选项、电子邮箱、手机号码、位置信息、设备信息**等。
    </p>
    <p>
    ...
    <p>
      ...
      Cookie，网站能够存储您的访问偏好数据。 我们不会将 Cookie
    ...
    <p>
      （1）广告、媒体：我们可能会将收集到的信息共享给广告、媒体以及我们的其他授权合作伙伴，用于包括优化广告投放和提升营销效果等商业化用途。<br />
      （2）我们的Minecraft内容合作伙伴：包括minemev.com。我们只会共享您的用户名，不包括其他信息，这是为了对您的内容进行署名。
    </p>
    <p>
    ...
    <h4>（四）共享、转让、公开披露信息时事先征得授权同意的例外</h4>
    <p>
    ...
    <h4>（一）访问您的用户信息</h4>
    <p>
      您有权访问您的用户信息，法律法规规定的例外情况除外。如果您想行使数据访问权，可以通过以下方式自行访问：登陆后访问
      <a href="https://redenmc.com/api/account/profile"
        >https://redenmc.com/api/account/profile</a
      >
    </p>
    <p>
      如果您无法通过上述链接访问这些用户信息，您可以随时使用我们的 Web
      表单联系，或发送电子邮件至zly2006@redenmc.com。我们将在30天内回复您的访问请求。
    </p>
    <p>
      对于您在使用我们的产品或服务过程中产生的其他用户信息，只要我们不需要过多投入，我们会向您提供。如果您想行使数据访问权，请发送电子邮件至zly2006@redenmc.com。
    </p>
    <h4>（二）更正您的用户信息</h4>
    <p>
    ...
    <p>
      ...
      表单联系，或发送电子邮件至zly2006@redenmc.com。我们将在30天内回复您的更正请求。
    </p>
    <h4>（三）删除您的用户信息</h4>
    ...
    <h4>（四）改变您授权同意的范围</h4>
    <p>
      每个业务功能需要一些基本的用户信息才能得以完成（见本政策“第一部分”）。对于用户信息的收集和使用，您可以随时给予或收回您的授权同意。您可以通过以下方式自行操作：发送邮件至zly2006@redenmc.com
    </p>
    <p>
    ...
    <h4>（五）用户信息主体注销账户</h4>
    <p>
      您随时可注销此前注册的账户，您可以通过以下方式自行操作：发送邮件至zly2006@redenmc.com
    </p>
    <p>
      在注销账户之后，我们将停止为您提供产品或服务并依据您的要求，删除或匿名化您的信息，法律法规另有规定的除外。这也将可能导致您失去对您账户中数据的访问权，请您谨慎操作。
    </p>
    <h4>（六）用户信息主体获取用户信息副本</h4>
    <p>
      您有权获取您的用户信息副本，您可以通过以下方式自行操作：发送邮件至zly2006@redenmc.com
    </p>
    <p>
    ...
    <p>
      ...
      电子邮件：zly2006@redenmc.com
    </p>
    <p>一般情况下，我们将在三十天内回复。</p>
    <p>
      如果您对我们的回复不满意，特别是我们的用户信息处理行为损害了您的合法权益，
    </p>
  </div>
</template>
